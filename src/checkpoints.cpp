...
namespace Checkpoints
{
    ...
    // Matadorscoin: synchronized checkpoint (centrally broadcasted)
    ...
    // Matadorscoin: get last synchronized checkpoint
    ...
    // Matadorscoin: only descendant of current sync-checkpoint is allowed
    ...
    // Matadorscoin: reset synchronized checkpoint to last hardened checkpoint
...
// Matadorscoin: sync-checkpoint master key
...
// Matadorscoin: verify signature of sync-checkpoint message
...
// Matadorscoin: process synchronized checkpoint
