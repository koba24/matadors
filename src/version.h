...
// Copyright (c) 2012-2013 The Matadorscoin developers
...
// Matadorscoin version - intended for display purpose only
...
// Matadorscoin version - reference for code tracking
#define MCOIN_VERSION_MAJOR       1
#define MCOIN_VERSION_MINOR       0
#define MCOIN_VERSION_REVISION    0
#define MCOIN_VERSION_BUILD       0

static const int MCOIN_VERSION =
                           1000000 * MCOIN_VERSION_MAJOR
                         +   10000 * MCOIN_VERSION_MINOR
                         +     100 * MCOIN_VERSION_REVISION
                         +       1 * MCOIN_VERSION_BUILD;
