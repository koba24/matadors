...
public:
    ...
    {
        // Matadorscoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // Matadorscoin: get transaction coin age
...
public:
    ...
    // Matadorscoin: block signature - signed by coin base txout[0]'s owner
    ...
    // Matadorscoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Matadorscoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // Matadorscoin: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // Matadorscoin: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // Matadorscoin: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // Matadorscoin: block index flags
    enum  
    {
