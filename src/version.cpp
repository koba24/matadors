...
// Copyright (c) 2014 The Matadorscoin developers
...
// for both Matadorscoind and Matadorscoin(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of Matadorscoin releases, the client name should be selected from
