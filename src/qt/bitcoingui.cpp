/*
 * Qt4 Matadorscoin GUI.
 *
 * W.J. van der Laan 2011-2012
 * The Bitcoin Developers 2011-2012
 * The Matadorscoin Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Matadorscoin Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/Matadorscoin_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Matadorscoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/Matadorscoin_tooltip"), tr("&About Matadorscoin"), this);
    aboutAction->setToolTip(tr("Show information about Matadorscoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Matadorscoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/Matadorscoin_tooltip"), tr("Show/Hide &Matadorscoin"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Matadorscoin window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/Matadorscoin_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/Matadorscoin_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/Matadorscoin_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Matadorscoin client"));
    trayIcon->setIcon(QIcon(":/icons/Matadorscoin_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Matadorscoin network", "", count));
}
